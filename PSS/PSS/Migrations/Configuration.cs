    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DBContext>
    {
        ...
        private void SeedStates()
        {
            db.States.AddOrUpdate(s => s.Id,
                ...
                /* BEGIN - TODO: Entity Issue
                    new State { Id = 27, UF = "AL", CountryId = 63, Name = "Alabama" },
                    new State { Id = 28, UF = "AK", CountryId = 63, Name = "Alasca" },
                    new State { Id = 29, UF = "AR", CountryId = 63, Name = "Arcansas" },
                    new State { Id = 30, UF = "AZ", CountryId = 63, Name = "Arizona" },
                    new State { Id = 31, UF = "CA", CountryId = 63, Name = "Califórnia" },
                    new State { Id = 32, UF = "KS", CountryId = 63, Name = "Cansas" },
                    new State { Id = 33, UF = "NC", CountryId = 63, Name = "Carolina do Norte" },
                    new State { Id = 34, UF = "SC", CountryId = 63, Name = "Carolina do Sul" },
                    new State { Id = 35, UF = "CO", CountryId = 63, Name = "Colorado" },
                    new State { Id = 36, UF = "CT", CountryId = 63, Name = "Conecticute" },
                    new State { Id = 37, UF = "ND", CountryId = 63, Name = "Dakota do Norte" },
                    new State { Id = 38, UF = "SD", CountryId = 63, Name = "Dakota do Sul" },
                    new State { Id = 39, UF = "DE", CountryId = 63, Name = "Delaware" },
                    new State { Id = 40, UF = "FL", CountryId = 63, Name = "Flórida" },
                    new State { Id = 41, UF = "GA", CountryId = 63, Name = "Geórgia" },
                    new State { Id = 42, UF = "HI", CountryId = 63, Name = "Havaí" },
                    new State { Id = 43, UF = "ID", CountryId = 63, Name = "Idaho" },
                    new State { Id = 44, UF = "RI", CountryId = 63, Name = "Ilha de Rodes" },
                    new State { Id = 45, UF = "IL", CountryId = 63, Name = "Ilinóis" },
                    new State { Id = 46, UF = "IN", CountryId = 63, Name = "Indiana" },
                    new State { Id = 47, UF = "IA", CountryId = 63, Name = "Iowa" },
                    new State { Id = 48, UF = "KY", CountryId = 63, Name = "Kentucky" },
                    new State { Id = 49, UF = "LA", CountryId = 63, Name = "Luisiana" },
                    new State { Id = 50, UF = "ME", CountryId = 63, Name = "Maine" },
                    new State { Id = 51, UF = "MD", CountryId = 63, Name = "Marilândia" },
                    new State { Id = 52, UF = "MA", CountryId = 63, Name = "Massachusetts" },
                    new State { Id = 53, UF = "MI", CountryId = 63, Name = "Míchigan" },
                    new State { Id = 54, UF = "MN", CountryId = 63, Name = "Minesota" },
                    new State { Id = 55, UF = "MS", CountryId = 63, Name = "Mississípi" },
                    new State { Id = 56, UF = "MO", CountryId = 63, Name = "Missúri" },
                    new State { Id = 57, UF = "MT", CountryId = 63, Name = "Montana" },
                    new State { Id = 58, UF = "NE", CountryId = 63, Name = "Nebrasca" },
                    new State { Id = 59, UF = "NV", CountryId = 63, Name = "Nevada" },
                    new State { Id = 60, UF = "NH", CountryId = 63, Name = "Nova Hampshire" },
                    new State { Id = 61, UF = "NJ", CountryId = 63, Name = "Nova Jérsei" },
                    new State { Id = 62, UF = "NY", CountryId = 63, Name = "Nova Iorque" },
                    new State { Id = 63, UF = "NM", CountryId = 63, Name = "Novo México" },
                    new State { Id = 64, UF = "OK", CountryId = 63, Name = "Oclaoma" },
                    new State { Id = 65, UF = "OH", CountryId = 63, Name = "Ohio" },
                    new State { Id = 66, UF = "OR", CountryId = 63, Name = "Óregon" },
                    new State { Id = 67, UF = "PA", CountryId = 63, Name = "Pensilvânia" },
                    new State { Id = 68, UF = "TN", CountryId = 63, Name = "Tenessi" },
                    new State { Id = 69, UF = "TX", CountryId = 63, Name = "Texas" },
                    new State { Id = 70, UF = "UT", CountryId = 63, Name = "Utá" },
                    new State { Id = 71, UF = "VT", CountryId = 63, Name = "Vermonte" },
                    new State { Id = 72, UF = "VA", CountryId = 63, Name = "Virgínia" },
                    new State { Id = 73, UF = "WV", CountryId = 63, Name = "Virgínia Ocidental" },
                    new State { Id = 74, UF = "WA", CountryId = 63, Name = "Washington" },
                    new State { Id = 75, UF = "WI", CountryId = 63, Name = "Wisconsin" },
                    new State { Id = 76, UF = "WY", CountryId = 63, Name = "Wyoming" }
                
                END - TODO: Entity issue */
                );
        }
        ...
        private void SeedCities()
        {
            db.Cities.AddOrUpdate(c => c.Id,
                ...
                /* BEGIN - TODO: Entity Issue
                    ...
                    new City { Id = 32, StateId = 27, Name = "Montgomery" },
                    new City { Id = 33, StateId = 28, Name = "Juneau" },
                    new City { Id = 34, StateId = 29, Name = "Little Rock" },
                    new City { Id = 35, StateId = 30, Name = "Phoenix" },
                    new City { Id = 36, StateId = 31, Name = "Sacramento" },
                    new City { Id = 37, StateId = 32, Name = "Topeka" },
                    new City { Id = 38, StateId = 33, Name = "Raleigh" },
                    new City { Id = 39, StateId = 34, Name = "Columbia" },
                    new City { Id = 40, StateId = 35, Name = "Denver" },
                    new City { Id = 41, StateId = 36, Name = "Hartford" },
                    new City { Id = 42, StateId = 37, Name = "Bismarck" },
                    new City { Id = 43, StateId = 38, Name = "Pierre" },
                    new City { Id = 44, StateId = 39, Name = "Dover" },
                    new City { Id = 45, StateId = 40, Name = "Tallahassee" },
                    new City { Id = 46, StateId = 41, Name = "Atlanta" },
                    new City { Id = 47, StateId = 42, Name = "Honolulu" },
                    new City { Id = 48, StateId = 43, Name = "Boise" },
                    new City { Id = 49, StateId = 44, Name = "Providence" },
                    new City { Id = 50, StateId = 45, Name = "Springfield" },
                    new City { Id = 51, StateId = 46, Name = "Indianápolis" },
                    new City { Id = 52, StateId = 47, Name = "Des Moines" },
                    new City { Id = 53, StateId = 48, Name = "Frankfort" },
                    new City { Id = 54, StateId = 49, Name = "Baton Rouge" },
                    new City { Id = 55, StateId = 50, Name = "Augusta" },
                    new City { Id = 56, StateId = 51, Name = "Annapolis" },
                    new City { Id = 57, StateId = 52, Name = "Boston" },
                    new City { Id = 58, StateId = 53, Name = "Lansing" },
                    new City { Id = 59, StateId = 54, Name = "Saint Paul" },
                    new City { Id = 60, StateId = 55, Name = "Jackson" },
                    new City { Id = 61, StateId = 56, Name = "Jefferson City" },
                    new City { Id = 62, StateId = 57, Name = "Helena" },
                    new City { Id = 63, StateId = 58, Name = "Lincoln" },
                    new City { Id = 64, StateId = 59, Name = "Carson City" },
                    new City { Id = 65, StateId = 60, Name = "Concord" },
                    new City { Id = 66, StateId = 61, Name = "Trenton" },
                    new City { Id = 67, StateId = 62, Name = "Albany" },
                    new City { Id = 68, StateId = 63, Name = "Santa Fe" },
                    new City { Id = 69, StateId = 64, Name = "Oklahoma City" },
                    new City { Id = 70, StateId = 65, Name = "Columbus" },
                    new City { Id = 71, StateId = 66, Name = "Salem" },
                    new City { Id = 72, StateId = 67, Name = "Harrisburg" },
                    new City { Id = 73, StateId = 68, Name = "Nashville" },
                    new City { Id = 74, StateId = 69, Name = "Austin" },
                    new City { Id = 75, StateId = 70, Name = "Salt Lake City" },
                    new City { Id = 76, StateId = 71, Name = "Montpelier" },
                    new City { Id = 77, StateId = 72, Name = "Richmond" },
